...
const zh: Record<string, string> = {
  ...
  'home.map.title': 'M0–M5 是学习模块，L1–L3 是授课深度',
  'home.map.subtitle':
    '矩阵只是组织方式。真正交付时，它对应的是学习模块、课时深度、硬件材料和项目产出。',
  ...
  'mapLegend.note': '每个模块都可以按 L1/L2/L3 三个深度单独引入，也可以跨模块组合成完整学习包。',
  ...
  'course.explorerTitle': '六个可引入学习模块',
  'course.explorerSubtitle':
    '每个模块都包含真实硬件、课堂实验、能力目标和可带走材料。可以单独引入，也可以组合成系列学习模块。',
  ...
  'courseMatrix.srCaption':
    '学习矩阵：横轴为 M0–M5 六个模块，纵轴为 L1–L3 三个层级；每格列出该模块在该层级的学习标题、时长与产出。',
  ...
  'courseAxis.subtitle':
    'M0–M5 说明学习方向，L1 / L2 / L3 说明授课深度。机构引入时，可以按模块和级别确定学习包范围。',
  'courseAxis.l1': '展示层｜看得懂、能演示',
  'courseAxis.l2': '顾问层｜独立配置可用系统',
  'courseAxis.l3': '设计层｜业务集成与深度定制',

  'trackFlow.title': '三大学习方向',
  'trackFlow.subtitle': '按学习目标拼模块；M0 是零基础旗舰入口，M1–M5 按方向组合。',
  'trackFlow.viewCombo': '查看这组学习组合',

  'pathOr.moduleRange': '模块范围',
  'pathOr.chooseDirection': '选 M0–M5 中的学习方向',
  ...
  'pathDepth.subheading': 'L1 展示层 / L2 顾问层 / L3 设计层对应学习深度，不是用户身份标签。',
  'pathDepth.cta': '在完整矩阵里查看每个模块的 L1 / L2 / L3',

  'pathTracks.title': '三大学习方向',
  'pathTracks.subtitle': '三个并列方向，按学习目标给出建议组合。',
  ...
  'heroMap.title': 'M0–M5 × L1/L2/L3 学习矩阵',
  'heroMap.subtitle': '每个模块都可按 L1/L2/L3 三个深度独立引入，也可以跨模块组合成完整学习包。',
  ...
  'cta.courses.title': '把学习模块引入你的教学、团队或项目现场',
  'cta.courses.desc':
